...
namespace assets {
	...
	Model astroidModel{ std::vector<Mesh>{astroidMesh} };

	Mesh bossMesh{ { { 5, 0 }, { 3, -2 }, { 2, -1 }, { -3, -3 }, { -1, 0 }, { -3, 3 }, { 2, 1 }, { 3, 2 }, { 5, 0 } }, Color{1.0f, 0.5f, 0.0f} };
	Model bossModel{ std::vector<Mesh>{bossMesh} };

	Mesh bulletMesh{ { Vector2{ -1, -1 }, Vector2{ 1, 0 }, Vector2{ -1, 1 }, Vector2{ -1, -1 }, }, Color{ 1.0f, 1.0f, 0.0f } };
