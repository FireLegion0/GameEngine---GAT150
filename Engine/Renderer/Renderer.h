...
namespace nu {
	class Renderer {
		public:
			...
			void DrawTexture(const class Texture& texture, struct Rect& source, float x, float y, float angle = 0.0f, float scale = 1.0f, bool flipH = false, const Vector2& origin = Vector2{ 0.5f,0.5f }) const;
